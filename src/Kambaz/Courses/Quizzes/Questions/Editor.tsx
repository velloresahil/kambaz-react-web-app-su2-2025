...
//     // SIMPLIFIED: Just handle radio button selection
...
//             });
//             // Update correctAnswer to the text of the selected option
//             handleInputChange("correctAnswer", newOptions[index].text);
//         } else if (field === 'text') {
...
//                                 <small className="text-muted d-block">Add all options and select the correct answer's radio button</small>
//                             </Card.Header>
//                             <Card.Body>
...
//                                     </div>
//                                 ))}
//                                 <Button variant="outline-danger" onClick={addOption}>
//                                     Add Option
//                                 </Button>
//                             </Card.Body>
//                         </Card>
...
//             correctAnswer: correctAnswer,
//             options: formData.options || [],
//             published: true, // Set to published for save and publish
//             quiz: qid!,
//         };
...
//             navigate(`/Kambaz/Courses/${cid}/Quizzes/${qid}/Questions`);
//         } catch (err) {
//             console.error("Error saving and publishing question:", err);
//             alert("Failed to save and publish question.");
//         }
//     };
